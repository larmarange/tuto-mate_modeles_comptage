...
-   S'obtient toujours avec `glm()` mais en indiquant `family = quaispoisson`
...
Le modèle de quasi-Poisson n'a pas suffit à régler le problème de surdispersion dans le cadre de notre exemple.
...
-   une variable binaire peut-être modélisée avec un modèle de comptage, en considérant que la personne a vécu 0 fois ou 1 fois l'événèment d'intérêt

-   permets de calculer des *prevalence ratios* (ou risques relatifs) plutôt que des *odds ratio*
